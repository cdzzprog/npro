...
# 打开多波段TIF文件并读取其坐标参考系
with rasterio.open(r'C:\Users\龙儿璨\Desktop\湿地制图\朱杭\img\WetlandXJ_202308_T44_AW_70.tif') as src:
    ...
    # 应用阈值（0到1），生成水体掩膜
    water_mask = np.where((ndwi >= 0.05) & (ndwi <= 1), 1, 0)
...
# 输出为Shapefile
gdf.to_file(r'C:\Users\龙儿璨\Desktop\湿地制图\label\WetlandXJ_202308_T44_AW_4_label22.shp')