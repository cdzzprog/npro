...
# 定义输入文件夹路径和输出文件夹路径
input_folder_1 = r'C:\Users\龙儿璨\Desktop\湿地制图\其他\3'  # 替换为你的输入水体文件夹路径
input_folder_2 = r'C:\Users\龙儿璨\Desktop\湿地制图\其他\4'  # 替换为你的输入植被文件夹路径
output_folder = r'C:\Users\龙儿璨\Desktop\湿地制图\merge0'
...
for file_name in os.listdir(input_folder_1):
    if file_name.endswith('.shp'):
        ...
        if os.path.exists(file_2):
            ...
            # 构建输出文件的路径
            output_file = os.path.join(output_folder, file_prefix + '_combined.shp')
