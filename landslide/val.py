...
# 加载测试数据
test_image_dir = 'E:\数据集\山体滑坡数据集\landslide\image1'
test_label_dir = 'E:\数据集\山体滑坡数据集\landslide\mask1'
...
model.load_state_dict(torch.load('E:\\repository\\models_building_128.pth', weights_only=True))
model.eval()
