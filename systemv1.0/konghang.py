...
# 示例用法
doc_path = r'E:\papers\zip\软著模板\高原地区山体滑坡遥感智能识别系统v1.0\高原地区山体滑坡遥感智能识别系统V1.0-源码.docx'  # 替换为实际的文档路径
...
# 示例用法
doc_path = r'E:\papers\zip\软著模板\高原地区山体滑坡遥感智能识别系统v1.0\高原地区山体滑坡遥感智能识别系统V1.0-源码.pdf'  # 替换为实际的文档路径
